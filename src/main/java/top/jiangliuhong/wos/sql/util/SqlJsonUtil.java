...
import top.jiangliuhong.wos.sql.exception.JsonException;
...
public final class SqlJsonUtil {
    ...
    public static <T> T toObject(String json, Class<T> clzz) {
        if (SqlStringUtil.isNullOrEmpty(json))
            return null;
    ...
    public interface Customizer {
        ...
        default void onStarted(ObjectMapper objectMapper) {
            SqlJsonUtil.config(objectMapper);
        }
    }
}
