...
import top.jiangliuhong.wos.sql.builder.internal.*;
import top.jiangliuhong.wos.sql.exception.NotSupportedException;
...
public interface FromBuilder {
    ...
    static void checkSourceAndAlia(List<Froms> list) {
        for (Froms froms : list) {
            ...
            if (SqlStringUtil.isNotNull(source) && !Parser.contains(source)) {
                String tip = "";
